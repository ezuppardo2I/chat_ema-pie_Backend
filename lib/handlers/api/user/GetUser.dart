...
import 'package:dart_template/models/User.dart';
import 'dart:convert';
import 'package:dart_template/models/UserPutRequest.dart';
...
Future<AwsApiGatewayResponse> putUser(
  ...
  try {
    ...
    if (request.email.isNotEmpty) {
      ...
      if (userID != null) {
        final newUser = User(userID: userID, email: request.email);
        await db.putItem(
